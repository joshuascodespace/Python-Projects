            ...
            if len(descendants) == 2 or all(encountered_species_are_in_descendants):
                ...
                if len(descendants) == 2:
                    ...
                    if (all(encountered_species_are_in_descendants)):
                        ...
                        # The new branches get a fraction of the weight of the descendants based on how they compare to the biggest element.
                        weight = descendants_abundance[parent] * sample[species] / sample[max_children[parent]]
                        break
                else:
                    child = children[0]
                while(True):
